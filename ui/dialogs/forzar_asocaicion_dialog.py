...
class ForzarAsociacionDialog(QDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle("Forzar Asociación")
        self.resize(600, 420)
    ...
    def _build_ui(self):
        ...
        self.btn_asociar.clicked.connect(self._on_asociar)
    ...
    def _load(self):
        ...
        rows = AuditoriaUseCase.load_archivos(self.recepcion_id)
